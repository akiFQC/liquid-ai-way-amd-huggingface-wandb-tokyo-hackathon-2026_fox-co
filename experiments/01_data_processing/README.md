...
| カテゴリ (JSON key) | [OpenPII 1.5M](https://www.google.com/search?q=ai4privacy/pii-masking-openpii-1.5m) の該当ラベル | [ner-wikipedia-dataset](https://github.com/stockmarkteam/ner-wikipedia-dataset) の該当ラベル |
| --- | --- | --- |
...
| `experiments/data/ner_wikipedia_processed/` | `stockmarkteam/ner-wikipedia-dataset` |
